<template>
    <div class="input-element" :style="elementStyles" @click.stop="selectElement">
        <label v-if="element.label" :style="labelStyles">{{ element.label }}</label>
        <input :type="element.inputType" :placeholder="element.placeholder" :style="inputStyles" @dblclick.stop="startEditing" />
