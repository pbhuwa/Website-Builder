<template>
    <div class="about-us-element" :style="elementStyles" @click.stop="selectElement">
        <!-- Background Section -->
        ...
        <div class="about-us-content" :style="contentStyles">
            <!-- Title Section -->
            <div class="about-title" :style="titleStyles" @dblclick.stop="startEditing('title')">
            ...
            <div class="mission-section">
                <h3 class="section-title" :style="sectionTitleStyles" @dblclick.stop="startEditing('missionTitle')">
                ...
                <div class="section-content" :style="sectionContentStyles" @dblclick.stop="startEditing('missionContent')">
            ...
            <div class="team-section" v-if="element.showTeam">
                <h3 class="section-title" :style="sectionTitleStyles" @dblclick.stop="startEditing('teamTitle')">
                    <span v-if="!editing.teamTitle">{{ element.team.title }}</span>
                    <input v-else v-model="element.team.title" @blur="stopEditing('teamTitle')" @keydown.enter.stop="stopEditing('teamTitle')" />
                </h3>
                <div class="team-members">
                    <div class="team-member" v-for="(member, index) in element.team.members" :key="index">
                        <div class="member-image-container">
                            <img :src="member.image || '/placeholder-profile.jpg'" :alt="member.name" class="member-image" />
                        </div>
                        <div class="member-details">
                            <h4 @dblclick.stop="startEditingMember(index, 'name')">
                            ...
                            <p @dblclick.stop="startEditingMember(index, 'position')">
        ...
        return {
            element: {
                ...
                mission: {
                    title: 'Our Mission',
                    content:
                        "We are dedicated to providing exceptional services and products that make a difference in people's lives. Our team works tirelessly to ensure customer satisfaction and innovation in everything we do.",
                },
                showTeam: true,
                team: {
                    title: 'Meet Our Team',
    ...
    computed: {
        ...
        backgroundStyles() {
            return {
                ...
                backgroundImage: this.element.backgroundStyles.image ? `url(${this.element.backgroundStyles.image})` : 'none',
    ...
    methods: {
        ...
        startEditing(field) {
            if (this.isSelected) {
                ...
                this.$nextTick(() => {
                    const ref =
                        `${field}Editor` in this.$refs ? this.$refs[`${field}Editor`] : this.$el.querySelector(`[v-model="element.${field}"]`);
                    ref?.focus();
                });
            }
        },
